...
if __name__ == "__main__":
    ...
    target_number=500
    data_path = f"{project_dir}/generated_data/executable_tools/filtered/no_tool_use"
    sample_data_path = f"{project_dir}/generated_data/executable_tools/sampled/executable_tools_no_tool_use_gpt_sample_{target_number}.jsonl"
