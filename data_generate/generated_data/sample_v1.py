...
def run_sample(folder_path, sample_data_path, sample, target_number=400):
    ...
    for category,data in category_data.items():
        ...
        if len(data) <= sample_number:
            print(f"Not enough data in {category}, taking all {len(data)} items.")
...
if __name__ == "__main__":
    ...
    target_number=3000
    data_path = f"{project_dir}/generated_data/executable_tools/filtered/v1"
    sample_data_path = f"{project_dir}/generated_data/executable_tools/sampled/executable_tools_v1_sample_{target_number}_no_filter.jsonl"
