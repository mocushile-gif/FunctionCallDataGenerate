...
if __name__ == "__main__":
    ...
    model = QwQFunction()
    label_data_path = f"{project_dir}/generated_data/executable_tools/generated/task"
    category_data_path=f'{project_dir}/generated_data/executable_tools/filtered/v2'
    ...
    label_data_path = f"{project_dir}/generated_data/executable_tools/generated/v4"
    category_data_path=f'{project_dir}/generated_data/executable_tools/filtered/v4'
