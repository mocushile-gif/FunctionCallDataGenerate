...
if __name__ == "__main__":
    ...
    target_number=3000
    data_path = f"{project_dir}/generated_data/executable_tools/filtered/v2"
    sample_data_path = f"{project_dir}/generated_data/executable_tools/sampled/executable_tools_v2_gpt_sample_{target_number}.jsonl"
    
    # sample = {'all_self_multimode_qwq': 1, 
    #             'all_self_task_qwq': 1, 
    #             'file_system_task_database_qwq': 0.5, 
    #             'file_system_task_qwq': 1,
    #             'all_self+xlam_multimode_qwq': 3, 
    #             }
    # sample = {'all_self_multimode_gpt': 1, 
    #             'all_self_task_gpt': 1, 
    #             'file_system_task_database_gpt': 0.5, 
    #             'file_system_task_gpt': 1,
    #             'all_self+xlam_multimode_gpt': 1,
    #             'code_intepreter_gpt':1,
    #             'file_system_dependent_gpt':1
    #             }
    sample = {'gpt':1}
