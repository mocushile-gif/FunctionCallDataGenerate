...
def get_cat_breed_info_by_id(breed_id: str, save_to: Optional[str] = None):
    """
    Get specific cat breed information by ID from the Cat API.
    
    Parameters:
    - breed_id (str): Breed ID to retrieve information for
...
if __name__ == "__main__":
    ...
    result = get_cat_breed_info_by_id(breed_id="asho", save_to="./cat_breed_result.json")
