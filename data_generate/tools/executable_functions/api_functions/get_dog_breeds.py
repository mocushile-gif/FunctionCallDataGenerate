...
def get_dog_breeds(limit: Optional[int] = None, page: Optional[int] = None, 
...
if __name__ == "__main__":
    ...
    result = get_dog_breeds(limit=100, save_to="./dog_breeds_result.json")
