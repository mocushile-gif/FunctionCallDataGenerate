...
def get_dog_image_info_by_id(image_id: str, save_to: Optional[str] = None):
    """
    Get specific dog image information by ID from the Dog API.
...
if __name__ == "__main__":
    ...
    result = get_dog_image_info_by_id(image_id="Hyjcol947", save_to="./dog_image_result.json")
