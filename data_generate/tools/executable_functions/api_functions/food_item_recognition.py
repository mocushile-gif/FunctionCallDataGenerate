...
def food_item_recognition(
    ...
    # Call RapidAPI
    url = "https://food-item-recognition.p.rapidapi.com/"
    headers = {
        "x-rapidapi-key": os.getenv("RAPID_API_KEY"),
        "x-rapidapi-host": "food-item-recognition.p.rapidapi.com",
...
if __name__ == "__main__":
    ...
    image_input = "./image_data/food.png"  # 本地图片
    # image_input = "https://i.imgur.com/IEygXiv.jpeg"  # 远程图片

    result = food_item_recognition(
        image=image_input,
    )
