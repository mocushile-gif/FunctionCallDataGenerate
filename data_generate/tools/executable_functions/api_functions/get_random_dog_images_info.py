...
def get_random_dog_images_info(limit: Optional[int] = None, page: Optional[int] = None, 
    ...
    """
    Get random dog images from the Dog API.
...
if __name__ == "__main__":
    ...
    result = get_random_dog_images_info(limit=25, order="RAND", save_to="./dog_images_result.json")
