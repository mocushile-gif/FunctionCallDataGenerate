...
save_path="$PROJECT/generated_data/executable_tools/generated/no_tool_use/generate_executable_all_self+xlam_miss_func_gpt.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_all_self+xlam_miss_func_gpt.jsonl"
...
python $PROJECT/pipeline.py \
    ...
    --mode_weights '{"single":0, "parallel":0, "multiple":0, "dependent":0, "no_tool_use":1, "miss_param":0,"task":0}' \
