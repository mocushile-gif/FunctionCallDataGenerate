...
save_path="$PROJECT/generated_data/executable_tools/generated/task/generate_executable_file_system_task_database_qwq.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_file_system_task_qwq.jsonl"
...
target_generate_data_number=1000
