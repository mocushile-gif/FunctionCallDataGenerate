...
save_path="$PROJECT/generated_data/executable_tools/generated/generate_executable_file_system_gpt.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_file_system_gpt.jsonl"
...
python $PROJECT/pipeline.py \
    ...
    --tool_model_name 'gpt' \
    --lang 'en' \
    --task_turn_weights '{"1":3,"2":2,"3":1,"4":1}' \
    --mode_weights '{"single":0, "parallel":0, "multiple":0, "dependent":1, "no_tool_use":0}' \
    --tool_nums_distribution '{"9": 100, "8": 100, "7": 200, "6": 300, "5": 400, "4": 300, "3": 200, "2": 100, "1": 50}' \
    --file_system_path $file_system_path \
    --files_num '{"1":0,"2":0.5,"3":0.5}' \
    --use_persona \
