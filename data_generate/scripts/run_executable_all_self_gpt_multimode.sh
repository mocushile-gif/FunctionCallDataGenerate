...
save_path="$PROJECT/generated_data/executable_tools/generated/v4/generate_executable_all_self_multimode_gpt.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_file_system_multimode_gpt.jsonl"
...
tool_defines_path="['$PROJECT/tools/defines/file_system_functions','$PROJECT/tools/defines/database_functions','$PROJECT/tools/defines/api_functions']"
...
file_system_path="$PROJECT/working_dir/file_system_new2"
