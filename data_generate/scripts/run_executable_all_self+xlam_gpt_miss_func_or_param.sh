...
save_path="$PROJECT/generated_data/executable_tools/generated/v3/generate_executable_all_self+xlam_miss_func_or_param_gpt.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_all_self+xlam_miss_func_or_param_gpt.jsonl"
tool_defines_path="['$PROJECT/tools/defines/xlam_rapidapi_tools','$PROJECT/tools/defines/python_functions','$PROJECT/tools/defines/file_system_functions','$PROJECT/tools/defines/database_functions']"

num_workers=10 #多线程生成
target_generate_data_number=500
...
python $PROJECT/pipeline.py \
    ...
    --mode_weights '{"single":1, "parallel":1, "multiple":1, "dependent":1, "no_tool_use":5, "miss_param":5,"task":0}' \
