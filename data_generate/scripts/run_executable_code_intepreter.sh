...
save_path="$PROJECT/generated_data/executable_tools/generated/generate_executable_shangtang_without_info.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_shangtang_without_info.jsonl"
tool_defines_path="['$PROJECT/tools/defines/file_system_functions']"
...
file_system_path="$PROJECT/working_dir/shangtang_file_system/"
...
python $PROJECT/pipeline.py \
    ...
    --tool_model_name 'qwq' \
    --lang 'zh' \
    --task_turn_weights '{"1":3,"2":3,"3":2,"4":1}' \
    --mode_weights '{"single":1, "parallel":1, "multiple":0, "dependent":1, "no_tool_use":1}' \
    --file_system_path $file_system_path \
    --fixed_tools "['file_system_functions.code_intepreter']" \
    --files_num '{"1":0.2,"2":0.5,"3":0.3}' \
    --use_persona \
    --provide_file_system_info 'path'\
