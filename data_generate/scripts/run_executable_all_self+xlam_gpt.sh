...
save_path="$PROJECT/generated_data/executable_tools/generated/task/generate_executable_all_self+xlam_multimode_gpt.jsonl"
failed_save_path="$PROJECT/generated_data/executable_tools/failed/failed_generate_executable_all_self+xlam_multimode_gpt.jsonl"
...
python $PROJECT/pipeline.py \
    ...
    --mode_weights '{"single":0, "parallel":0, "multiple":0, "dependent":0, "no_tool_use":0, "miss_param":0,"task":1}' \
