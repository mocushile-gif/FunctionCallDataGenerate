...
save_path="$PROJECT/generated_data/executable_tools/generated/task/generate_executable_all_self_task_gpt.jsonl"
...
python $PROJECT/pipeline.py \
    ...
    --mode_weights '{"single":0, "parallel":0, "multiple":0, "dependent":0, "no_tool_use":1, "task":1}' \
