...
if __name__ == "__main__":
    ...
    response_file=[
    f'{project_dir}/generated_data/executable_tools/generated/v4/generate_executable_all_self_multimode_gpt.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v3/generate_executable_all_self_multimode_gpt.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v2/generate_executable_all_self_multimode_gpt.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v2/generate_executable_all_self_task_gpt.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v2/generate_executable_file_system_dependent_gpt.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v2/generate_executable_file_system_task_gpt.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v2/generate_executable_all_self_multimode_qwq.jsonl',
    f'{project_dir}/generated_data/executable_tools/filtered/v3/generate_executable_all_self_multimode_qwq.jsonl',
    ]
    tools_define_paths=[
        f'{project_dir}/tools/defines/file_system_functions',
    # f'{project_dir}/tools/defines/python_functions',
    # f'{project_dir}/tools/defines/database_functions',
    f'{project_dir}/tools/defines/api_functions',
    ]
    ...
    for origin_tool_name in tool_defines.keys():
        ...
        tool_responses=tool_response_dict.get(tool_name,'')
        if not tool_responses:
            print(origin_tool_name)
        collect_tool_responses[tool_name]=tool_responses
    with open(f'{fsp_dir}/tools/tool_response_collections_self.json','w',encoding='utf-8') as f:
